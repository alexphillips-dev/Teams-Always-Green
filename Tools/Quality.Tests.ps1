...
Describe "Quality: Uninstall Flow" {
    ...
    It "hardens uninstall with safety checks, foreground progress UI, and full removal retries" {
        ...
        $script:uninstallText | Should -Match 'function\s+Get-KnownLockerProcesses'
        $script:uninstallText | Should -Match 'function\s+Stop-KnownLockerProcesses'
        $script:uninstallText | Should -Match 'function\s+Schedule-PathRemovalAtReboot'
        $script:uninstallText | Should -Match 'function\s+Try-RenamePathForCleanup'
        $script:uninstallText | Should -Match 'function\s+Invoke-UninstallRetryGuidance'
        $script:uninstallText | Should -Match 'function\s+Invoke-UninstallHealthCheck'
        $script:uninstallText | Should -Match 'function\s+Get-ResidualPathSnapshot'
        $script:uninstallText | Should -Match 'function\s+Write-UninstallPhaseMarker'
        ...
        $script:uninstallText | Should -Match 'MoveFileEx'
        $script:uninstallText | Should -Match 'Deferred cleanup scheduled for reboot'
